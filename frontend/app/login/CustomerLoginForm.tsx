  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <button
        ...
        className="mt-1 w-full rounded-xl bg-gradient-to-r from-[#d4a843] to-[#e8c547] px-5 py-3.5 text-sm font-semibold text-[#07070d] transition hover:opacity-90 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
      >
      ...
      <div className="relative py-2">
        ...
        <div className="relative flex justify-center">
          <span className="bg-[#07070d] px-4 text-xs text-white/30">Or sign in with</span>
        </div>
      </div>
      ...
      <p className="pt-1 text-center text-xs text-white/35">
        New here?{" "}
        <Link href={signupHref} className="text-[#d4a843] hover:text-[#e8c547] transition-colors">
          Create an account
        </Link>
      </p>
    </form>
